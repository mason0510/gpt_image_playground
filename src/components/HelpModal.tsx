          ...
          <section className="rounded-2xl border border-blue-100 bg-blue-50/80 p-4 dark:border-blue-500/20 dark:bg-blue-500/10">
            ...
            {isAgentMode ? (
              <ol className="list-decimal pl-4 space-y-2 text-blue-900/90 dark:text-blue-100/90">
                <li>先点右上角 <strong>设置</strong>，在 API Key 处选择 <strong>限时免费 key</strong>（每天 10 张）体验，或切到 <strong>自定义 API Key</strong> 填写自己的 key。</li>
          ...
          {isAgentMode ? (
            ...
            <>
              <section>
                ...
                <div className="space-y-4">
                  <ul className="list-disc pl-4 space-y-2">
                    <li>首次进入建议先打开右上角 <strong>设置</strong>：可选择 <strong>限时免费 key</strong>（每天 10 张）快速体验，也可填写自己的 API Key。</li>
            ...
            <>
              <section>
                ...
                <div className="space-y-4">
                  <ul className="list-disc pl-4 space-y-2">
                    <li>先完成接口配置：可选择 <strong>限时免费 key</strong>（每天 10 张）快速体验，也可填写自己的 API Key，再开始生成。</li>
